            ...
            <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md">
                <div class="flex flex-col items-center pb-3">
                    ...
                    <div class="flex mt-4 space-x-3 lg:mt-6">
                        ...
                        <a wire:click.prevent="$set('caseId','{{ $case->id }}')" data-modal-toggle="extralarge-modal" class="inline-flex items-center py-2 px-3 text-lg font-semibold text-center bg-green-500 text-white rounded-lg border
    ...
    <div class="relative p-4 w-full max-w-7xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 ">
                <button data-modal-toggle="extralarge-modal" Wire:click.prevent="Approved"  type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300
