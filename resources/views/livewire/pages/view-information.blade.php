                ...
                <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md">
                    <div class="flex flex-col items-center pb-3">
                        ...
                        <div class="flex mt-4 space-x-3 lg:mt-6">
                            ...
                            <a href="#"
                                class="inline-flex items-center py-2 px-3 text-lg font-semibold text-center bg-rose-500 text-white rounded-lg border
                                 border-rose-500  hover:bg-rose-700 focus:ring-4 focus:outline-none ">
