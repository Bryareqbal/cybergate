    ...
    <div class=" px-2 container mx-auto rounded-lg my-6 space-y-10">
        ...
        @if ($users->IsNotEmpty())
            ...
            @if (session()->has('success'))
                <div class="bg-green-100 border-l-4  py-1 border-green-500 text-green-700 p-4 mb-4" role="alert">
                    {{ session('success') }}
                </div>
            @elseif(session()->has('error'))
                <div class="bg-red-100 border-l-4  py-1 border-red-500 text-red-700 p-4 mb-4" role="alert">
                    {{ session('error') }}
                </div>
            @endif
            ...
            <div class="container md:mx-auto overflow-auto ">
                        ...
                        @foreach ($users as $user)
                            <tr class="border-b border-gray-200 hover:bg-gray-100 text-xl">
                                ...
                                border-gray-300 focus:shadow-outline-purple form-input disabled:bg-gray-100">
                                        ...
                                        <option {{ $user->permission === 'cyber' ? 'selected' : '' }} value="cyber">
                                            Cyber</option>
                                        <option {{ $user->permission === 'asaysh' ? 'selected' : '' }} value="asaysh">
                                            Asaysh
                                        </option>
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        @can('isSuperadmin')
                                            <a wire:click="switchUser('{{ $user->id }}')"
                                ...
                                <div class="relative p-4 w-full max-w-7xl h-full md:h-auto">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow ">
                                        ...
                                        <div class="p-6 space-y-6">
                                            ...
                                            <div
                                                class="grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1  mt-0 md:divide-y-0 divide-y-2 lg:divide-x-2 divide-gray-400">
                                                <div class="mt-0 p-5">
                                                    <form wire:submit.prevent="EditUser('{{ $user->id }}')"
                                                        ...
                                                        <div class="flex flex-col space-y-3">
                                                            <div class="">
                                                                ...
                                                                <input wire:model.defer="editUserForm.newName"
                                                                    type="text" class="w-full px-3 py-2 rounded ">
                                                            </div>
                                                            ...
                                                            <div class="basis-1/2">
                                                                ...
                                                                <input wire:model.defer="editUserForm.newEmail"
                                                                    type="email" class="w-full px-3 py-2 rounded ">
                                                            </div>
                            ...
                            dark:focus:ring-blue-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2   ">
                                                ...
                                                @else
                                                    <div class="mt-0 p-5">
                                                        <form
                                                            wire:submit.prevent="EditPassword('{{ $user->id }}')">
                                                            ...
                                                            <div class="flex flex-col space-y-1">
                                                                ...
                                                                <input wire:model.defer="confirmPassword"
                                                                    type="password" class="px-3 py-2 rounded ">
                ...
                <div class="bg-white mt-1">
                    <div class="flex justify-end mr-2 p-2">
                        {{ $users->links() }}
                    </div>
                </div>
                ...
                <div class="relative bg-white rounded-lg shadow-lg">
                    ...
                    <div class="py-6 px-6 lg:px-8">
                        ...
                        <form method="POST" class="space-y-3" wire:submit.prevent="createUser">
                            ...
                            <button type="submit"
                                class="px-3 py-2 bg-green-500 rounded text-white w-full">Create</button>
